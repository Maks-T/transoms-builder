...
export const useEstimateStore = defineStore('estimate', {
    ...
    getters: {
         ...
         */
        attachProfilesPerCell() {

            const transom = this.modelingStore.activeTransom
            if (!transom || !transom.cells || !transom.profile ||!transom.profile.attachProfiles) return []

            const attachProfiles = transom?.profile?.attachProfiles

            if (!attachProfiles) return []

            const cells = this.modelingStore.calculatedCells || []
            ...
            cells.forEach(cell => {
                ...
                directions.forEach(dir => {
                    const neighCells = this.modelingStore.getNeighbors(cell)[dir]
