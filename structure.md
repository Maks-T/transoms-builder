...
│           ├── ModelingSettingsPanel.vue    # Панель настроек
│           ├── FrameBuilder/             # Компоненты визуального построителя
│           │   ├── LeafElement.vue   # Компонент для отрисовки/редактирования фреймов
...
│           └── ModelingToolbar.vue  # Панель инструментов для моделирования
│
